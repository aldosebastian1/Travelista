    ...
    <div className="min-h-screen bg-slate-50 pt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="flex flex-col items-center text-center mb-24 max-w-3xl mx-auto">
          <h2 className="font-cinzel text-3xl font-light text-slate-900 mb-6">
            Standar Kemewahan Tanpa Kompromi
          </h2>
          <p className="text-slate-600 font-light leading-relaxed">
            Setiap porsi perjalanan dibentuk dengan dedikasi tinggi terhadap kenyamanan dan
            estetika. Dari resor terpencil hingga ekspedisi privat, kami merancang setiap detik
            untuk kesempurnaan Anda.
          </p>
        </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 mb-12">
                    {pkg.highlights.map((h) => (
                      <div key={h} className="flex items-center gap-3">
                        ...
                        <span className="text-[0.9rem] font-light text-slate-700 uppercase tracking-widest">
                          {h}
                        </span>
                      </div>
                    ))}
