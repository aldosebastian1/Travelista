...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Temukan dan pesan paket wisata premium ke destinasi terbaik Indonesia dan dunia.",
    images: [
      {
  ...
  return (
    <html lang="id" className={`${cinzel.variable} ${poppins.variable} ${inter.variable}`}>
      ...
      <body className="antialiased flex flex-col min-h-screen bg-slate-50 text-slate-800">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-9999 focus:bg-blue focus:text-white focus:px-6 focus:py-3 focus:rounded-[8px] focus:font-semibold focus:shadow-lg transition-all"
        >
