...
export const metadata = {
    ...
    description: "Pengalaman privat tak terlupakan, dikisahkan langsung oleh para tamu eksklusif kami.",
};
        ...
        <div className="min-h-screen bg-slate-50 pt-20">
            ...
            <div className="bg-[#0A0A0A] pt-32 pb-24 px-6 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
                    ...
                    <p className="text-slate-400 text-lg md:text-xl font-light">
                        Kepercayaan yang dianugerahkan oleh kalangan paling selektif. Dipercaya dalam menyusun ribuan kenangan berharga.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-24">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
                    {testimonials.map((t) => (
                        ...
                        >
                            ...
                            <blockquote
                                className="text-slate-800 text-xl font-light leading-relaxed mb-10 italic"
                                style={{ fontFamily: "var(--font-cinzel)" }}
                            >
                                "{t.text}"
                            </blockquote>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <p className="font-medium text-[0.85rem] tracking-widest uppercase text-slate-900">{t.name}</p>
                ...
                <div className="mt-32 text-center border-t border-slate-200 pt-24">
                    ...
                    <h2
                        className="text-4xl lg:text-5xl font-light text-slate-900 mb-10"
                        style={{ fontFamily: "var(--font-cinzel)" }}
                    >
