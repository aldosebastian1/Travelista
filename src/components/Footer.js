    ...
    <footer className="bg-noir text-slate-300">
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-12 grid grid-cols-1 md:grid-cols-12 gap-16 lg:gap-8">
        ...
        <div className="md:col-span-5">
          <Link href="/" className="inline-block mb-8 group" aria-label="Travelista beranda">
            <span className="font-cinzel text-2xl font-light text-white tracking-[0.2em] transition-colors duration-500 group-hover:text-blue">
              TRAVELISTA
            </span>
          </Link>
          <p className="text-[0.9rem] leading-loose text-slate-300 font-light max-w-sm mb-10">
            Mengkurasi perjalanan paling eksklusif ke destinasi premier dunia. Privasi, kemewahan,
            dan layanan tanpa kompromi.
          </p>
        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <ul className="space-y-4 text-[0.85rem] font-light">
            {[
              ...
              {
                href: "/destination?category=Honeymoon",
                label: "Private Honeymoon",
              },
              {
                href: "/destination?category=Internasional",
                label: "Eksplorasi Global",
              },
            ].map(({ href, label }) => (
              <li key={label}>
        ...
        <div className="md:col-span-3 space-y-8">
          ...
          <ul className="space-y-4 text-[0.85rem] font-light mb-8">
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+6283839350200" className="footer-contact-link tracking-wider">
                +62 838 3935 0200
              </a>
            </li>
            <li className="flex items-center gap-3">
              <Mail size={14} className="text-slate-400" strokeWidth={1.5} />
              <a href="mailto:concierge@travelista.id" className="footer-contact-link">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="border-t border-white/5 py-8 flex flex-col md:flex-row justify-between items-center gap-6 text-[0.75rem] font-light tracking-wide uppercase">
          <p>
            © {currentYear} Travelista. <span className="text-slate-600 hidden sm:inline">|</span>{" "}
