        ...
        >
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-slate-700 placeholder:text-slate-400 transition-colors duration-500"
                />
            </div>
            ...
            <button
                type="submit"
                className="w-full mt-2 py-4 bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 text-white rounded-xl font-bold transition-colors duration-500 shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2"
            >
