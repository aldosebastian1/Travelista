...
export default function TestimonialsSection() {
    return (
        <section
            ...
            className="bg-transparent py-32 px-6"
        >
                    ...
                    {testimonials.map((t) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4 pt-6 border-t border-slate-100 mt-auto">
                                ...
                                <div>
                                    <p className="font-medium text-slate-900 text-[0.85rem] tracking-widest uppercase">{t.name}</p>
                                    <p className="text-blue text-xs tracking-widest uppercase mt-1">{t.packageName}</p>
                                </div>
                            </div>
                        </article>
                    ))}
